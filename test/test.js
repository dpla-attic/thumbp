...
describe('Connection', function() {
    ...
    var c, request, response,
        returnErrorStub, consoleErrorStub, libRequestStub;

    before(function() {
        consoleErrorStub = sinon.stub(console, 'error');
        libRequestStub = sinon.stub(libRequest, 'Request');
        libRequestStub.on = function() { return libRequestStub; };
        libRequestStub.pipe = function() { return true; };
    });

    beforeEach(function() {
        request = {
            method: 'GET',
            on: function() { return request; }
        };
        response = {
            setHeader: function() {}
        };
    ...
    describe('lookUpImage()', function() {
        ...
        it('makes an Elasticsearch request with the correct URL', function() {
            ...
            var goodURL = 'http://localhost:9200/dpla_alias/item' +
